...
import nuxt_plugin_router_15a03107 from 'nuxt_plugin_router_15a03107' // Source: .\\router.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"Monolith Research","titleTemplate":"%s - Monolith Research","meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"Nuxt.js project"}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"}],"style":[],"script":[]},
  ...
  if (typeof nuxt_plugin_router_15a03107 === 'function') {
    await nuxt_plugin_router_15a03107(app.context, inject)
  }
